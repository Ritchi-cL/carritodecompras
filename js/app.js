...
const buscador = document.querySelector("#submit-buscador");
...
function cargarRegistrarEventListeners() {
    ...
    // Detener la ejecución del buscador
    buscador.addEventListener("click", detenerEjecucion);

}

function detenerEjecucion(event) {
